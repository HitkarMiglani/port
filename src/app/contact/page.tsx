            ...
            {[
              {
                ...
                answer:
                  "I specialize in web development, machine learning applications, and data visualization projects. I'm particularly interested in creating user-friendly interfaces and developing AI solutions for real-world problems.",
              },
              {
                question: "What is your typical process for new projects?",
                answer:
                  "My process typically involves an initial consultation, requirement gathering, planning, design, development, testing, and deployment. I maintain communication throughout to ensure your vision is being realized.",
              },
              {
                question: "How long does a typical project take?",
                answer:
                  "Project timelines vary based on scope and complexity. A simple website might take 2-4 weeks, while a complex web application or machine learning project could take 2-3 months. I'll provide a detailed timeline during our initial consultation.",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
