    ...
    <section className="pt-24 pb-12 px-8 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            A motivated 3rd-year Computer Science & Engineering student
            passionate about AI, Machine Learning, and building innovative web
            applications.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://leetcode.com/u/hitkar_miglani/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
